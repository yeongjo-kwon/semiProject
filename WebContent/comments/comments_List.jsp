...
<body>
	...
	<input type="text" name="bookno" id="bookno" value="${bookno}">
		<h3 class="book-info-title link">
			<button type="submit"	class="gtm-review-2depth">한 줄 리뷰
				<span class="number"><%=cmtservice.selectCommentsCnt(Integer.parseInt(bookno)) %> </span><i
		  ...
		  %>
				<ul class="review-list">
					<li>
						...
						<i class="fas fa-user-circle fa-2x" style="color: #757575"></i>
						...
						<div class="info">
							...
							<span class="date"><%=commSdf.format(commList.get(i).getRegdate()) %></span>
									 <a	href="<c:url value='/comments/comments_detail.do?no=${bookno}'/>" 
